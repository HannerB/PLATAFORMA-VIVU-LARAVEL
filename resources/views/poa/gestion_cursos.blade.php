            ...
            <form action="{{ route('gestion-curso.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="Nivel_Formacion" class="form-select" required>
                        ...
                        <option value="Certificacion por competencias Laborales">Certificación por competencias Laborales</option>
        ...
        <tbody>
            @foreach($consulta as $curso)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editModal{{ $curso->id_Gestion_Cursos }}">
                            Editar
                        </button>
                        <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteModal{{ $curso->id_Gestion_Cursos }}">
                            Borrar
                        </button>
                        {{-- <a href="{{ route('cursos.detalle', $curso->id_Gestion_Cursos) }}" class="btn btn-warning btn-xs">
                            Ver Detalle
                        </a> --}}
                    </td>
                </tr>
